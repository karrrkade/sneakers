  ...
  return (
    <div className="wrapper clear">
      ...
      <div className="content p-40">
        ...
        <div className="content__wrap d-flex">
          <div className="card">
            ...
            <div className="d-flex justify-between align-center">
              <div className="card__priceWrap d-flex flex-column">
                <span className="card__priceTitle text-uppercase">Цена:</span>
                <b className="card__price">12 999 руб.</b>
              </div>
              <button className="card__plus">
